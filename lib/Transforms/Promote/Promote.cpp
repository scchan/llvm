...
namespace {
    ...
    if ( I1 ) {
      ...
      for(Value::user_iterator CU = CE->user_begin(),
        ...
        if (Instruction *I2 = dyn_cast<Instruction>(*CU)) {
          ...
          // update operand, a new Instruction may br created along the way
          Instruction *newI1 = updateInstructionWithNewOperand(I1, oldOperand, newOperand, updates);

          // updates Instruction may be a complete new Instruction
          ...
          for (Value::user_iterator CU2 = CE2->user_begin(), CUE2 = CE2->user_end(); CU2 != CUE2;) {
            if (Instruction *I3 = dyn_cast<Instruction>(*CU2)) {
              ...
              // notice additional Insturction may be produced along the
  ...
  Instruction * updateLoadInstWithNewOperand(LoadInst * I, Value * newOperand, InstUpdateWorkList * updatesNeeded)
  {
  ...
  Instruction * updatePHINodeWithNewOperand(PHINode * I, Value * oldOperand, Value * newOperand, InstUpdateWorkList * updatesNeeded)
  {
  ...
  Instruction * updateStoreInstWithNewOperand(StoreInst * I, Value * oldOperand, Value * newOperand, InstUpdateWorkList * updatesNeeded)
  {
  ...
  Instruction * updateCallInstWithNewOperand(CallInst * CI, Value * oldOperand, Value * newOperand, InstUpdateWorkList * updatesNeeded)
  {
  ...
  Instruction * updateBitCastInstWithNewOperand(BitCastInst * BI, Value *oldOperand, Value * newOperand, InstUpdateWorkList * updatesNeeded)
  {
  ...
  Instruction * updateAddrSpaceCastInstWithNewOperand(AddrSpaceCastInst * AI, Value *oldOperand, Value * newOperand, InstUpdateWorkList * updatesNeeded)
  {
  ...
  Instruction * updateGEPWithNewOperand(GetElementPtrInst * GEP, Value * oldOperand, Value * newOperand, InstUpdateWorkList * updatesNeeded)
  {
  ...
  Instruction * updateCMPWithNewOperand(CmpInst *CMP, Value *oldOperand, Value *newOperand, InstUpdateWorkList *updatesNeeded)
  {
  ...
  Instruction * updatePtrToIntWithNewOperand(PtrToIntInst *PTI, Value *oldOperand, Value *newOperand, InstUpdateWorkList *updatesNeeded)
  {
  ...
  Instruction * updateSELWithNewOperand(SelectInst * SEL, Value * oldOperand, Value * newOperand, InstUpdateWorkList * updatesNeeded)
  {
  ...
  Instruction * updateAtomicRMWWithNewOperand(AtomicRMWInst *ARMWI, Value * oldOperand, Value * newOperand, InstUpdateWorkList * updatesNeeded)
  {
                                                ...
                                                InstUpdateWorkList * updatesNeeded)
  {
    ...
    if (PtrToIntInst *PTI = dyn_cast<PtrToIntInst>(I)) {
      return updatePtrToIntWithNewOperand(PTI, oldOperand, newOperand, updatesNeeded);
    }
    ...
    if (AtomicRMWInst *ARMWI = dyn_cast<AtomicRMWInst>(I)) {
      return updateAtomicRMWWithNewOperand(ARMWI, oldOperand, newOperand, updatesNeeded);
    }
